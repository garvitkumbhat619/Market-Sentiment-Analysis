...
async def lifespan(app: FastAPI):
    ...
    app.state.tokenizer = AutoTokenizer.from_pretrained("./models/bert_sentiment")
    print("Loading BERT model...")
    app.state.bert_model = AutoModelForSequenceClassification.from_pretrained("./models/bert_sentiment")
